...
export default defineComponent({
  ...
  setup(props, { emit, slots }) {
    ...
    const inputAttrs = computed(() => ({
      ...
      class: [
        'hc-input focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-500',
        props.error ? 'hc-input-error' : '',
      ],
      ...
      if (props.label) {
        children.push(
          h(
            ...
            [props.label, props.required ? h('span', { class: 'ml-1 text-danger', 'aria-hidden': 'true' }, '*') : null],
          ),
        );
      }

import { computed, defineComponent, h } from 'https://unpkg.com/vue@3/dist/vue.esm-browser.js';
...
export default defineComponent({
  ...
  setup(props, { emit, slots }) {
    ...
    const inputAttrs = computed(() => ({
      ...
      class: ['hc-input', props.error ? 'hc-input-error' : null].filter(Boolean).join(' '),
      ...
      if (props.label) {
        children.push(
          h(
            ...
            [props.label, props.required ? h('span', { class: 'hc-form-label__required', 'aria-hidden': 'true' }, '*') : null],
          ),
        );
      }
